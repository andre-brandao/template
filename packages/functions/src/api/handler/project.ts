...
export namespace ProjectApi {
  ...
  export const route = new Hono()
    .get(
      "/",
      doc(Project.list.meta, { 200: doc.page(Project.Info) }),
      authRequired,
    ...
    .get(
      "/:id",
      doc(Project.fromID.meta, { 200: doc.json(Project.Info) }),
      authRequired,
      validator("param", id),
    ...
    .post(
      "/",
      doc(Project.create.meta, { 200: doc.json(Project.Info) }),
      authRequired,
    ...
    .patch(
      "/:id",
      doc(Project.update.meta, { 200: doc.json(Project.Info) }),
      authRequired,
      validator("param", id),
    ...
    .delete(
      "/:id",
      doc(Project.remove.meta, { 200: doc.ok }),
      authRequired,
      validator("param", id),
      async (c) => {
